...
class TestGetFilePath:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "/tmp/repo",
                "/tmp/repo/deep/nested/path/file.md",
                False,
            ),
    ...
    def test_get_file_path(
        ...
        if should_raise:
            ...
            assert result.startswith(abs_repo_path + os.sep) or result == abs_repo_path
    ...
    def test_relative_repo_path(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                expected = os.path.abspath(os.path.join(relative_repo, "file.txt"))
    ...
    def test_edge_cases(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert (
                result1.startswith(abs_repo_path + os.sep) or result1 == abs_repo_path
            )
