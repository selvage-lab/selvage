...
class TestSynthesisAPIClient:
    ...
    def test_execute_synthesis_success(
        ...
        assert cost.model == "gpt-5.3-codex"  # sample_model_info의 full_name 사용
    ...
    def test_calculate_synthesis_cost_openai(
        ...
        mock_cost_estimator.return_value = EstimatedCost.get_zero_cost("gpt-5.3-codex")

        # When: 비용 계산
        cost = api_client._calculate_synthesis_cost(
            ModelProvider.OPENAI, mock_response, "gpt-5.3-codex"
        )
