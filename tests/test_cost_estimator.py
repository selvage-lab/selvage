...
class TestCostEstimator:
    ...
    def test_get_model_pricing_supported_model(self) -> None:
        ...
        pricing = CostEstimator._get_model_pricing("gpt-5.3-codex")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("gpt-5.3-codex", 1000, 500, 1.25, 10.0),  # $1.25/$10.00 per 1M
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("gemini-3.1-pro", 1000, 500, 1.25, 10.0),  # $1.25/$10.00 per 1M
            ("gemini-3.1-pro", 2000, 800, 0.15, 0.6),  # $0.15/$0.60 per 1M
        ],
    )
