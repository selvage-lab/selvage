...
class TestNewErrorHandling:
    ...
    def test_context_limit_error_detection_openai(self):
        ...
        error = Exception("This request would result in a token count that exceeds the context_length_exceeded limit")
    ...
    def test_context_limit_error_detection_anthropic(self):
        ...
        error = Exception("The prompt is too long and exceeds the maximum allowed length")  
    ...
    def test_review_result_context_limit_error(self):
        ...
        error = Exception("context_length_exceeded: This request would exceed the context limit")
        review_result = ReviewResult.get_error_result(error, "gpt-4", "openai") 
